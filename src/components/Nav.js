...
const Nav = () => {
    ...
    return (
        <div style={{  display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', padding: '1rem 0', background: 'white', fontFamily: 'Roboto, monospace', color: 'white', fontWeight: '900', gap: '1rem', fontWeight: '200', backgroundColor: 'white', fontSize: '0.75rem', height: '2rem', }}>
